...
$sql = "SELECT * FROM products where cid = 'c06' order by cid ASC";
        ...
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                <div class="filter-section">
                    ...
                    <label><input type="checkbox" name="filter" value="fsp"> FSP</label><br>
                    ...
                    <label><input type="checkbox" name="filter" value="super flower"> SUPER FLOWER</label><br>
                    <label><input type="checkbox" name="filter" value="thermaltake"> THERMALTAKE</label><br>
                    <label><input type="checkbox" name="filter" value="thermalright"> THERMALRIGHT</label><br>
            ...
            <div class="filter-group">
            <button data-target="srFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Continuous Power W <i class="fa-solid fa-caret-down"></i></button>
            <div id="srFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="550 watt"> 550 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="650 watt"> 650 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="750 watt"> 750 Watt </label><br>
                    <label><input type="checkbox" name="filter" value="850 watt"> 850 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="100 watt"> 1000 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="1050 watt"> 1050 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="1200 watt"> 1200 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="1600 watt"> 1600 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="2800 watt"> 2800 Watt</label><br>
