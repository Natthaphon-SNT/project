...
$sql = "SELECT * FROM products where cid = 'c09' order by cid ASC";
    ...
    <div class="main">
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                    <label><input type="checkbox" name="filter" value="BE QUIET"> BE QUIET</label><br>
                    <label><input type="checkbox" name="filter" value="DEEPCOOL"> DEEPCOOL</label><br>
                    <label><input type="checkbox" name="filter" value="ID-COOLING"> ID-COOLING</label><br>
            ...
            <div class="filter-group">
            <button data-target="fanFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Fan Quantity <i class="fa-solid fa-caret-down"></i></button>
            <div id="fanFilter" class="filter-dropdown">
                    <label><input type="checkbox" name="filter" value="1 PCS"> 1 PCS</label><br>
                    <label><input type="checkbox" name="filter" value="2 PCS"> 2 PCS</label>
