...
$sql = "SELECT * FROM products where cid = 'c03' order by cid ASC";
        ...
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                <div class="filter-section">
                    ...
                    <label><input type="checkbox" name="filter" value="INNO3D"> INNO3D</label><br>
                    <label><input type="checkbox" name="filter" value="LEADTEK"> LEADTEK</label><br>
                    <label><input type="checkbox" name="filter" value="GALAX"> GALAX</label><br>
            ...
            <div class="filter-group">
            <button data-target="srFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">GPU Series <i class="fa-solid fa-caret-down"></i></button>
            <div id="srFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="GeForce RTX™ 30 Series"> GeForce RTX™ 30 Series</label><br>
                    <label><input type="checkbox" name="filter" value="Radeon™ RX 6500 XT"> Radeon™ RX 6500 XT</label><br>
                    <label><input type="checkbox" name="filter" value="Radeon™ RX 7600"> Radeon™ RX 7600</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5080"> GeForce® RTX 5080</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5090"> GeForce® RTX 5090</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5070 Ti"> GeForce® RTX 5070 Ti</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5070"> GeForce® RTX 5070</label><br>
                    <label><input type="checkbox" name="filter" value="Radeon™ RX 9070 XT"> Radeon™ RX 9070 XT</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5060 Ti"> GeForce® RTX 5060 Ti</label><br>
                    <label><input type="checkbox" name="filter" value="Radeon™ RX 9060 XT"> Radeon™ RX 9060 XT</label><br>
                    <label><input type="checkbox" name="filter" value="GeForce® RTX 5050"> GeForce® RTX 5050</label>
            ...
            <div class="filter-group">
            <button data-target="mbFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Memory Size <i class="fa-solid fa-caret-down"></i></button>
            <div id="mbFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="4GB GDDR6"> 4GB GDDR6</label><br>
                    <label><input type="checkbox" name="filter" value="6GB GDDR6"> 6GB GDDR6</label><br>
                    <label><input type="checkbox" name="filter" value="8GB GDDR6"> 8GB GDDR6</label><br>
                    <label><input type="checkbox" name="filter" value="16GB GDDR6"> 16GB GDDR6</label><br>  
                    <label><input type="checkbox" name="filter" value="16GB GDDR7"> 16GB GDDR7</label><br>
                    <label><input type="checkbox" name="filter" value="32GB GDDR7"> 32GB GDDR7</label><br>
                    <label><input type="checkbox" name="filter" value="12GB GDDR7"> 12GB GDDR7</label><br>
                    <label><input type="checkbox" name="filter" value="8GB GDDR7"> 8GB GDDR7</label>
            ...
            <div class="filter-group">
            <button data-target="maxmemFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Power Requirement <i class="fa-solid fa-caret-down"></i></button>
            <div id="maxmemFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="64GB"> 1000 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="96GB"> 550 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="128GB"> 600 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="192GB"> 650 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="256GB"> 750 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="4096GB"> 800 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="128GB (2x 64GB)"> 850 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="128GB (2x 64GB)"> 500 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="128GB (2x 64GB)"> 450 Watt</label><br>
                    <label><input type="checkbox" name="filter" value="128GB (2x 64GB)"> 300 Watt</label>
