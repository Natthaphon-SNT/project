...
$sql = "SELECT * FROM products where cid = 'c05' order by cid ASC";
        ...
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="kingston"> KINGSTON</label><br>
                    <label><input type="checkbox" name="filter" value="lexar"> LEXAR</label><br>
                    <label><input type="checkbox" name="filter" value="wd"> WD</label>
            ...
            <div class="filter-group">
            <button data-target="srFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Capacity <i class="fa-solid fa-caret-down"></i></button>
            <div id="srFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="256gb"> 256GB</label><br>
                    <label><input type="checkbox" name="filter" value="512GB"> 512GB</label><br>
                    <label><input type="checkbox" name="filter" value="500gb"> 500GB </label><br>
                    <label><input type="checkbox" name="filter" value="1tb"> 1TB</label><br>
                    <label><input type="checkbox" name="filter" value="2tb"> 2TB</label>
            ...
            <div class="filter-group">
            <button data-target="proFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Interface <i class="fa-solid fa-caret-down"></i></button>
            <div id="proFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="pci express 3.0"> PCI Express 3.0</label><br>
                    <label><input type="checkbox" name="filter" value="pci express 4.0"> PCI Express 4.0</label>
