...
$sql = "SELECT * FROM products where cid = 'c01' ORDER BY cid ASC";
        ...
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="AMD"> AMD</label><br>
                    <label><input type="checkbox" name="filter" value="INTEL"> INTEL</label>
            ...
            <div class="filter-group">
            <button data-target="seriesFilter" class="filter-btn" style="border: 2px solid white; background-color: crimson; color: #fff; text-decoration: none;">Series <i class="fa-solid fa-caret-down"></i></button>
            <div id="seriesFilter" class="filter-dropdown">
                <div class="filter-section">
                    ...
                    <label><input type="checkbox" name="filter" value="PRO 4000 Series"> PRO 4000 Series</label><br>
            ...
            <div id="socketFilter" class="filter-dropdown">
                <div class="filter-section">
                    ...
                    <label><input type="checkbox" name="filter" value="LGA 1851"> LGA 1851</label><br>
