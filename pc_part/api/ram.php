...
$sql = "SELECT * FROM products where cid = 'c04' order by cid ASC";
        ...
        <div class="cover">
            ...
            <div id="brandFilter" class="filter-dropdown">
                <div class="filter-section">
                    <label><input type="checkbox" name="filter" value="ADATA"> ADATA</label><br>
                    <label><input type="checkbox" name="filter" value="APACER"> APACER</label><br>
                    <label><input type="checkbox" name="filter" value="CORSAIR"> CORSAIR</label><br>
                    <label><input type="checkbox" name="filter" value="crucial"> CRUCIAL</label><br>
                    <label><input type="checkbox" name="filter" value="hiksemi"> HIKSEMI</label><br>
                    <label><input type="checkbox" name="filter" value="kingston"> KINGSTON</label><br>
                    <label><input type="checkbox" name="filter" value="klevv"> KLEVV</label><br>
                    <label><input type="checkbox" name="filter" value="lexar"> LEXAR</label><br>
                    <label><input type="checkbox" name="filter" value="geil"> GEIL</label><br>
                    <label><input type="checkbox" name="filter" value="predator"> PREDATOR</label>
