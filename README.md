...
### Full scrape JIB (เฉพาะ 6 หมวดที่เลือก)
...
ครอบคลุมหมวดค้นหา JIB รหัส 42, 58, 60, 1419, 1420 และ 1393 โดยแยกสินค้าเป็น CPU, Mainboard, GPU, RAM, SSD, HDD, PSU, Case, Monitor, Mouse, Keyboard, Keypad, Graphic Tablet, Headset, Air/Liquid Cooler และหมวดอุปกรณ์เสริมที่เกี่ยวข้อง ตัวกรองตัดเครื่องอ่านแผ่น ซีดี/ดีวีดี การ์ดเสียง NAS และ RAM สำหรับ NAS แฟลชไดรฟ์ เมมโมรีการ์ด เครื่องอ่านการ์ด สวิตช์คีย์บอร์ดแยก ที่รองข้อมือ top plate แผ่นรองเมาส์ หูฟัง true wireless คาราโอเกะ สปีกเกอร์โฟน หัวแปลง ขาตั้งหูฟัง และพัดลมเคสตามที่กำหนด
